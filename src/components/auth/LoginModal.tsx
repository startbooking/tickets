  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userData = await authService.login({ 
        username:email, 
        password_hash: password // Se envía al endpoint de validación
      });
      ...
      if (userData.rol === 'CAJERO') navigate('/vender');
      if (userData.rol === 'DESPACHADOR') navigate('/despacho');
      if (userData.rol === 'ADMIN_AGENCIA') navigate('/agencia');
      if (userData.rol === 'SUPERADMIN') navigate('/dashboard');

  ...
  const consultarPasajero = async () => {
    ...
    try {
      ...
      if (pasajero) {
        ...
        // Si el pasajero es nuevo (404 controlado que retorna null), limpiamos los campos para escritura libre
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Input
                      id="documento"
                      className={cn(errorSeguridad && "border-destructive focus-visible:ring-destructive")}
